...
<nav class="w-1/4 p-4 bg-card">
    ...
    <button class="mt-4 bg-blue-500 text-white hover:bg-blue-600 active:bg-blue-700 p-2 rounded-lg w-full transition-colors duration-200">
        Log in
    </button>
    <div class="mt-4 bg-secondary text-secondary-foreground p-4 rounded-lg">
        <p>Create TikTok effects, get a reward</p>
    </div>
    <footer class="mt-4 text-muted-foreground">
        <p>Company</p>
        <p>Program</p>
        <p>Terms & Policies</p>
        <p>See more</p>
        <p class="mt-4">2024 TikTok</p>
    </footer>
</nav>