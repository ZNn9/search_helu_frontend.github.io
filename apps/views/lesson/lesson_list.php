                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <p class="small">
                          Create a new lesson using this form, make sure you fill them all
                        </p>
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-12">
                              <div class="form-group form-group-default">
                                ...
                                <select id="idCopyrightType" name="idCopyrightType" class="form-control" required>
                                  <!-- Options will be populated via JS -->
                                </select>
                              </div>
                            </div>
                            <div class="col-sm-12">
                              <div class="form-group form-group-default">
                                ...
                                <select id="idStatusType" name="idStatusType" class="form-control" required>
                                  <!-- Options will be populated via JS -->
                                </select>
                              </div>
                            </div>
      ...
      document.getElementById("addRowButton").addEventListener("click", async function() {
        ...
        try {
          ...
          if (res.ok) {
            ...
            $('#addRowModal').modal('hide'); // Close modal
